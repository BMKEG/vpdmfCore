...
public class ConstructVPDMfArchiveTest {
	
	ApplicationContext ctx;

	ConstructVpdmfArchive p;
...
//		zipFile = new File("target/tempVpdmf.zip");
	...
	/*@Test
	public final void testBuildOoEVVArchive() throws Exception {
				
		String[] args = new String[] { 
				ooevvSpecFile.getPath(), 
				ooevvSpecFile.getParentFile().getParent() + "/ooevv_VPDMf.zip",
				};
		
		ConstructVPDMfArchive.main(args);
				
	}
	
	@Test
	public final void testBuildKefedArchive() throws Exception {
				
		String[] args = new String[] { 
				kefedSpecFile.getPath(),
				kefedSpecFile.getParentFile().getParent() + "/kefed_VPDMf.zip",
				};
	...
	public final void testBuildDigLibArchive() throws Exception {
		...
		String[] args = new String[] { 
				digLibSpecFile.getPath(),
				ftdSpecFile.getPath(),
				peopleSpecFile.getPath(),
				"target/digitalLibrary_VPDMf.zip",
				};
	...
	public final void testBuildTriageArchive() throws Exception {
		...
		String[] args = new String[] { 
				triageSpecFile.getPath(),
				digLibSpecFile.getPath(),
				ftdSpecFile.getPath(),
				peopleSpecFile.getPath(),
				"target/triage_VPDMf.zip",
				};
